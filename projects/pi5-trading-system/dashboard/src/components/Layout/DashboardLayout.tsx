...
const navigation: NavigationItem[] = [
  ...
  { name: 'Strategies', href: '/strategies', icon: CubeIcon, roles: ['admin', 'trader'] },
      ...
      <div className="flex flex-col h-0 flex-1">
        ...
        <div className="flex-shrink-0 bg-primary-700 p-4">
          ...
          <div className="mt-2 flex items-center">
            <div className={`h-2 w-2 rounded-full mr-2 ${isConnected ? 'bg-success-400' : 'bg-danger-400'}`}></div>
        ...
        <header className="relative z-10 flex-shrink-0 flex h-16 bg-white shadow">
          ...
          <div className="flex-1 px-4 flex justify-between items-center">
            ...
            <div className="ml-4 flex items-center space-x-4">
              ...
              <div className="flex items-center">
                <div className={`h-3 w-3 rounded-full mr-2 ${isConnected ? 'bg-success-400' : 'bg-danger-400'}`}></div>
