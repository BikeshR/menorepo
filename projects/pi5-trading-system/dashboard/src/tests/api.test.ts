...
import { LoginFormData, CreateOrderFormData, CreateStrategyFormData } from '../types';
...
describe('API Service', () => {
  ...
  describe('Orders', () => {
    ...
    it('should get orders with filters', async () => {
      ...
      expect(mockAxiosInstance.get).toHaveBeenCalledWith('/api/v1/orders/?status_filter=filled&limit=10');
  ...
  describe('Strategies', () => {
    ...
    it('should control strategy', async () => {
      ...
      expect(mockAxiosInstance.post).toHaveBeenCalledWith(`/api/v1/strategies/${strategyId}/action`, {
        action,
        reason,
      });
    });
  ...
  describe('Error Handling', () => {
    it('should handle API error responses', async () => {
      ...
      await expect(apiService.login({ username: 'test', password: 'test' }))
        .rejects.toThrow();
    });
    ...
    it('should handle network errors', async () => {
      ...
      await expect(apiService.getPortfolioSummary())
