...
export function CollectionStats({ stats }: CollectionStatsProps) {
  return (
    <div className="bg-white dark:bg-gray-900 rounded-lg shadow-md border border-gray-200 dark:border-gray-800 p-6 space-y-6">
      <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Collection Stats</h2>
      ...
      {Object.keys(stats.byMember).length > 0 && (
        <div>
          <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-3">By Member</h3>
          <div className="space-y-2">
            {Object.entries(stats.byMember)
              ...
              .map(([member, count]) => (
                ...
                >
                  <span className="text-gray-900 dark:text-gray-100 font-medium">{member}</span>
      ...
      {Object.keys(stats.bySeason).length > 0 && (
        <div>
          <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-3">By Season</h3>
          <div className="space-y-2">
            {Object.entries(stats.bySeason)
              ...
              .map(([season, count]) => (
                <div
                  ...
                  className="flex items-center justify-between py-2 px-3 bg-gray-50 dark:bg-gray-800 rounded"
                >
                  <span className="text-gray-900 dark:text-gray-100 font-medium">{season}</span>
                  <span className="text-gray-700 dark:text-gray-300 font-mono text-sm">
                    {formatNumber(count)}
                  </span>
                </div>
      ...
      {Object.keys(stats.byClass).length > 0 && (
        <div>
          <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-3">By Class</h3>
          <div className="space-y-2">
